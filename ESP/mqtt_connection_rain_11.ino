/*
  TITOLO PROGETTO: pluviometro 
  Test LCD 128x64 I2C
  DATA APERTURA: 2018-09-01
  DATA MODIFICA: 2018-09-29
  AUTORE: LUG-VI
 
  REVISION HISTORY:
  - V1.1 (2018-09-29):
    -inserimento sensore temperatura/umidita DHT11
    -lcd 128x64 su I2C
  - V1.0 (2018-09-14): Primo rilascio 
  
  NOTE: Le librerie Adafruit per LCD sono state modificate
